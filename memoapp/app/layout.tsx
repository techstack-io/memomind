...
function AppNavbar({ userName = "Dan" }: { userName?: string }) {
    ...
    <header className="w-full px-6 py-4 sm:px-8 lg:px-10">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
        ...
        <nav className="hidden items-center gap-10 text-sm text-memo-neutral-700/70 md:flex">
          <a href="/dashboard" className="transition-colors duration-200 hover:text-memo-connection-600">
            Dashboard
          </a>
          <a href="/library" className="transition-colors duration-200 hover:text-memo-connection-600">
            Library
          </a>
          <a href="/journey" className="transition-colors duration-200 hover:text-memo-connection-600">
            Journey
          </a>
        </nav>
